...
const yearStyle =
  "mb-5 md:mb-0 bg-gray-300 dark:bg-gray-700 rounded-2xl flex justify-center items-center p-1 w-[50%]";
  ...
  return (
    <>
      <div className="flex items-center justify-center flex-col  w-full mx-auto h-auto relative">
        <div className="h-[100%] w-[5px] rounded-lg bg-slate-500 absolute left-[0%] md:left-[50%] bg-slate-300 dark:bg-slate-500"></div>
            ...
            <React.Fragment key={index}>
              <div className="hidden md:flex justify-center items-center my-4  w-full md:w-[80%] h-auto relative  ">
                ...
                <div className="order-2 w-[10%]">
                  <div className="absolute h-[30px] w-[30px] border-[5px] border-slate-300 dark:border-slate-500 rounded-full circle bg-gray-500 dark:bg-slate-900"></div>
                  <div className="h-[5px] bg-slate-500 rounded-lg bg-slate-300 dark:bg-slate-500"></div>
                </div>
